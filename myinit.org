...
* PATH
#+BEGIN_SRC emacs-lisp
  (setenv "anaconda3" "$HOME/anaconda3/bin/")
  (setenv "NVM_BIN" "$HOME/.nvm/versions/node/v12.16.1/bin")
  (setenv "yarn" "$HOME/.yarn/bin/")
  (setenv "PATH" (concat (getenv "PATH") ":" (getenv "NVM_BIN") ":" (getenv "anaconda3") ":" (getenv "yarn")))
  (setq exec-path (append exec-path '("$HOME/.nvm/versions/node/v12.16.1/bin")))
  (setq exec-path (append exec-path '("$HOME/anaconda3/bin/")))
  (setq exec-path (append exec-path '("$HOME/.yarn/bin/")))
#+END_SRC
* which key
#+BEGIN_SRC emacs-lisp
